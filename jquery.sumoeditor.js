    ...
    EasyEditor.prototype.utils = function(){
        ...
        if( $('.' + self.randomString + '-bind').length > 0 ) {
            ...
            $('html').delegate(self.elem, 'click keyup', function() {
                ...
                bindData = setTimeout(function(){ $('.' + self.randomString + '-bind').html( $(el).html() ); }, 250);
            });
        }
...
//                document.execCommand('italic', false, '');
    ...
    EasyEditor.prototype.alignleft = function(){
        ...
        var settings = {
            ...
            clickHandler: function(){
                self.wrapSelectionWithNodeName({ nodeName: 'p', style: 'text-align: left', cssClass: 'text-left', keepHtml: true });
            }
        };
    ...
    EasyEditor.prototype.aligncenter = function(){
        ...
        var settings = {
            ...
            clickHandler: function(){
                self.wrapSelectionWithNodeName({ nodeName: 'p', style: 'text-align: center', cssClass: 'text-center', keepHtml: true });
            }
        };
    ...
    EasyEditor.prototype.alignright = function(){
        ...
        var settings = {
            ...
            clickHandler: function(){
                self.wrapSelectionWithNodeName({ nodeName: 'p', style: 'text-align: right', cssClass: 'text-right', keepHtml: true });
            }
        };
